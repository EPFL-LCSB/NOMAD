...
for this_model in kinetic_models:
    ...
    fluxes = load_fluxes(this_tfa_sample, tmodel, kmodel,
                         density=DENSITY,
                         ratio_gdw_gww=GDW_GWW_RATIO,
                         concentration_scaling=CONCENTRATION_SCALING,
                         time_scaling=TIME_SCALING)

    concentrations = load_concentrations(this_tfa_sample, tmodel, kmodel,
                                         concentration_scaling=CONCENTRATION_SCALING)
...
df_all_nra_sols.to_csv('./../output/data/{}-fold-conc-change/all_nra_sols_across_models.csv'.format(MAX_FOLD_CONC_CHANGE))
df_unique_designs.to_csv('./../output/data/{}-fold-conc-change/all_unique_designs.csv'.format(MAX_FOLD_CONC_CHANGE))
