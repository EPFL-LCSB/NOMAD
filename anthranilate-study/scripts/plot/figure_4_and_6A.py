...
This is a script to generate the following figures
 ...
 2. The heatmap of NRA solutions for different combinations of design and model in Figure 6
...
ax.savefig("./../../output/figures/Figure_6_clustermap.png", bbox_inches='tight')
plt.close('all')
