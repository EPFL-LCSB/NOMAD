'''
Script to plot the figure S.10 - performance of the double mutant targeting DDPA and GLUDy only
'''
...
for conc, scaling in concentrations_to_plot.items():
    ...
    plt.savefig(folder_for_output + '/figure_S.10_{}.png'.format(conc))
    plt.close()
