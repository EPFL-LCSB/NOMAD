...
def make_generalized_reversible_hill_n_n_h1(stoichiometry):
    ...
    new_class_name = "H1GeneralizedReversibleHill"\
    ...
    class H1GeneralizedReversibleHill(KineticMechanism):
        """
    ...
    H1GeneralizedReversibleHill.__name__ += H1GeneralizedReversibleHill.suffix

    return H1GeneralizedReversibleHill