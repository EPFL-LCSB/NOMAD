"""
This is a script to generate the clustermap for the designs generated using eK_trpD9923
...
folder_to_data = './../../output/data/eK_trpD9923/'
folder_for_output = './../../output/figures/figure-S.10/'
...
plt.tight_layout()
plt.savefig(folder_for_output + 'figure_S.10_enzyme_design.png')
