"""
Plots for the nonlinear verification of the top 5 designs from eK_trpD9923 in a reactor setup
...
folder_with_data = './../../output/verification-top-5-designs-reactor/eK_trpD9923'
folders_with_exp_strains = './../../output/data/eK_trpD9923/**/'
...
for conc, scaling in concentrations_to_plot.items():
    ...
    plt.savefig(folder_for_output + 'figure_S.12_a_b_{}.png'.format(conc))
    plt.close()

source_data = pd.concat(source_data, axis=1)
source_data.to_csv(folder_for_output + 'source_data_a_b.csv')
