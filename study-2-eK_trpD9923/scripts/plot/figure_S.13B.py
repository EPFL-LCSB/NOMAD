"""
Plots for enzyme sensitivity analysis for top 5 designs from eK_trpD9923_d2 with all 3 enzymes being perturbed

Data is generated from V_expression_sensitivty_analysis.py for eK_trpD9923_d2
"""
...
for enz_to_plot in ENZYME_NUMBERS_TO_PLOT:
    if enz_to_plot < 3:
        folder_with_data = './../../output/enzyme-sensitivity/eK_trpD9923_d2/{}-percent/enzyme-{}/'.format(PERCENT_PERTURBATION, enz_to_plot)
    else:
        folder_with_data = './../../output/enzyme-sensitivity/eK_trpD9923_d2/{}-percent/all-enzymes/'.format(PERCENT_PERTURBATION)
    ...
    filename = './../../output/verification-top-5-designs-reactor/eK_trpD9923_d2/ode_sols_wt.csv'
