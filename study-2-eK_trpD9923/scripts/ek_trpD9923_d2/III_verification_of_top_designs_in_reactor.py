...
folder_for_output = './../../output/verification-top-5-designs-reactor/eK_trpD9923_d2'
...
for this_model in kinetic_models:
    ...
    """    
    Test each top design design in a reactor setting for this kinetic model    
    """
    ...
    for ix_design, this_design in this_model_designs.groupby('design_ix'):
        ...
        reset_reactor()
        # Apply all the interventions for d2 (trpD9923/pJLaroGfbrtktA)
