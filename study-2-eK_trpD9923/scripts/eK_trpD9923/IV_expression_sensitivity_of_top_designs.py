...
if ENZ_TO_PERTURB < 3:
    folder_for_output = './../../output/enzyme-sensitivity/eK_trpD9923/{}-percent/enzyme-{}'.format(PERCENT_PERTURBATION, ENZ_TO_PERTURB)
else:
    folder_for_output = './../../output/enzyme-sensitivity/eK_trpD9923/{}-percent/all-enzymes'.format(PERCENT_PERTURBATION)
