"""
This script generates designs for overproducing anthranilate in the enhanced kinetic models - eK_trpD9923
"""
import numpy as np
import pandas as pd
...
def reset_nmodel(tmodel, tfa_sample, fcc, ccc, type=NET):
    """
    Function to create a NRA object fur a given TFA sample and set of flux and control coefficients
    """
...
for this_model in kinetic_models:
    ...
    output_folder = './../../output/data/eK_trpD9923/{}/'.format(this_model)
    ...
    if SIMULATE_IN_REACTOR:
        ...
        ''' 3. Paper designs - W3110 trpD9923/pJLaroGfbr'''
        reset_reactor()
        ...
        ''' 4. Paper designs - W3110 trpD9923/pJLaroGfbrtktA'''
        reset_reactor()
        ...
        ''' 5. NRA designs - all alternatives'''
        sol_ode_alt = []
        for this_design in designs:
            ...
            # if DDPA is in the design, deregulate it
