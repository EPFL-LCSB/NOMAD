...
** data 
- NOMAD results for different allowable fold changes in concentration (3-fold, 5-fold etc.)
...
- The data for the wild type from the 3-fold-conc-change is also used to generate Figure 2
- The data from the 3-fold-conc-change is used to collate all unique designs and generate Figures 4, 5 and S.1A as well.
...
- The data in this subfolder is used to generate the plots for Figure S.2 C-F
...
- This data is used to generate Figure S.2A and S.2B
