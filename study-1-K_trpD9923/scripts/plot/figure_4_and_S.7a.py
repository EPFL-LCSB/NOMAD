...
This is a script to generate the following figures
 ...
 2. The heatmap of NRA solutions for different combinations of design and model in supplementary figure S.7a
...
ax.savefig("./../../output/figures/Figure_S.7a_clustermap.png", bbox_inches='tight')
plt.close('all')
