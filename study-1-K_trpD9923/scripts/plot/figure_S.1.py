'''
Script to generate figure S.1 in supplementary note S.I
...
-- Plot these means as a function of allowable conc fold change (figure S.7)
...
folder_to_data = './../../output/data/S.I-phenotype-perturbation-sensitivity/{}-fold-conc-change-{}-fold-enz-activity/{}'
folder_for_output = './../../output/figures/figure-S.1'
