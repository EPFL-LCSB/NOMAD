...
We plot the median/mean for wt and all the designs. This is part of Supplementary note VI, for figures S.8 a and b
"""
...
for conc, scaling in concentrations_to_plot.items():
    ...
    plt.savefig(folder_for_output + 'figure_S.8_a_b_{}.png'.format(conc))
    plt.close()
